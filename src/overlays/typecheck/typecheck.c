...
static char typeConversions[7][7] = {
	{ TYPE_CARDINAL, TYPE_CARDINAL, TYPE_CARDINAL, TYPE_LONGINT,  TYPE_CARDINAL, TYPE_LONGINT,  TYPE_REAL },
	...
	{ TYPE_LONGINT,  TYPE_LONGINT,  TYPE_CARDINAL, TYPE_LONGINT,  TYPE_LONGINT,  TYPE_LONGINT,  TYPE_REAL },
