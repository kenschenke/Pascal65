...
typedef enum {
    ...
    ccHash, ccPercent, ccEndOfFile, ccError,
} TCharCode;

typedef enum {
    tcDummy, tcIdentifier, tcNumber, tcString, tcEndOfFile, tcError,

    tcBOOLEAN, tcBYTE, tcCARDINAL, tcCHAR, tcINTEGER, tcLONGINT, tcREAL,
    tcSTRING, tcSHORTINT, tcWORD,
    ...
    tcMOD, tcNIL, tcNOT, tcOF, tcOR, tcXOR, tcPACKED, tcPROCEDURE,
    tcPROGRAM, tcRECORD, tcREPEAT, tcSET, tcTEXT,
    tcTHEN, tcTO, tcTYPE, tcUNIT, tcUNTIL, tcUSES, tcVAR,
    tcWHILE, tcWITH,
} TTokenCode;
